...
<div class="multiselect z-20 mb-6" class:readonly use:clickOutside on:click_outside={hidden == "" ? handleDropdown : ""}>
  <div class="tokens" class:showOptions on:click={handleTokenClick}>
    ...
    <svg
          ...
          height="18"
          viewBox="0 0 18 18"
          on:click={handleDropdown}><path d="M5 8l4 4 4-4z" /></svg
        >
  </div>
